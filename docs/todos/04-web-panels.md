...
- [ ] 15.1 **`server/web/app.py`** — aiohttp web application setup
...
- [ ] 15.2 **`server/web/auth.py`** — Admin authentication
...
- [ ] 15.4 **Server HTML templates** — Jinja2
...
- [ ] 16.1 **`client/web/app.py`** — aiohttp web application setup
...
- [ ] 16.3 **Client HTML templates** — Jinja2
  - `base.html`: shared layout (sidebar nav, header, footer, CSS/JS includes)
