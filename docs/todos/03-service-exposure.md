...
- [ ] 14.1 **`server/network_manager.py`** — Service Registry extension
...
- [ ] 14.4 **`client/service_exposure.py`** — Expose local services
...
- [ ] 14.5 **`client/service_consumer.py`** — Map remote services to local ports
...
- [ ] 14.6 **Integration with `tunnel_manager.py`**
